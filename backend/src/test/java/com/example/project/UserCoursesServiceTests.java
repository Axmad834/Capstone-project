...
class UserCoursesServiceTests {
    ...
    // Done so we avoid adding a course for a non-existent user
    @Test
    ...
    // Done so we avoid adding a non-existent course to a user
    @Test
    ...
    // Done so we avoid returning wrong or empty course list for a user
    @Test
    ...
    // Done so we avoid deleting a course that doesn't exist
    @Test
    ...
    // Done so we avoid allowing a user to delete a course they don't own
    @Test
