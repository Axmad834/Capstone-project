...
class CoursesServiceTests {
    ...
    // Done so we avoid missing courses when retrieving all of them
    @Test
    void testGetAllCourses() {
        List<Courses> courses = Arrays.asList(
                new Courses(1L, "Java", "Java basics", "img1.png", null,null),
                new Courses(2L, "Spring", "Spring Boot", "img2.png", null,null)
        );
    ...
    // Done so we avoid failing to save a new course correctly
    @Test
    void testAddCourse() {
        CoursesDto dto = new CoursesDto(null,"Java","Basics","img.png");
        Courses savedCourse = new Courses(1L,"Java", "Java basics", "img1.png", null,null);
    ...
    // Done so we avoid updating a non-existent course silently
    @Test
    ...
    // Done so we avoid failing to delete a course or calling delete incorrectly
    @Test
